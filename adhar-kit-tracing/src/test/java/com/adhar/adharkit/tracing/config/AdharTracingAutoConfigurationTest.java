package com.adhar.adharkit.tracing.config;

import com.adhar.adharkit.tracing.aspect.TracingAspect;
import com.adhar.adharkit.tracing.properties.AdharTracingProperties;
import com.adhar.adharkit.tracing.util.AdharTracing;
...
class AdharTracingAutoConfigurationTest {
    ...
    void testWebTracingConfiguration() {
        contextRunner
                ...
                .run(context -> {
                    // Verify web tracing configuration
                    AdharTracingProperties properties = context.getBean(AdharTracingProperties.class);
